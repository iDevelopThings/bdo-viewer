	...
	"data-[active=true]:bg-surface-3 data-[active=true]:text-fg",
	{
		variants        : {
			variant : {
				...
				root : "text-xs font-semibold uppercase tracking-wide text-fg-muted hover:bg-surface-2 hover:text-fg",
				// Nested items are regular, lower-emphasis nav rows.
				child : "text-sm text-fg-subtle hover:bg-surface-2 hover:text-fg",
			}
		},
		defaultVariants : {
			variant : "child",
