...
import {Combobox as ComboboxPrimitive, type ComboboxPositionerProps} from "@base-ui/react";
...
const ComboboxTriggerNoChevron       = React.forwardRef<
	HTMLButtonElement,
	ComboboxPrimitive.Trigger.Props
>(({className, children, ...props}, ref) => {
	return (
...
ComboboxTriggerNoChevron.displayName = "ComboboxTriggerNoChevron";
